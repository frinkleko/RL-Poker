...
class Drawcard(Card):
    def __init__(self,
        ...
        self.CARDB, CARDD = df.backgroundPNG(int(size * 1), int(size * 1.3), 'white')
        self.CARDB = df.roundCorners(self.CARDB, int(size * 0.05))
    ...
    def main(self):
        ...
        font = df.fontDefiner(self.Fontpath, int(size * 0.5))
